            ...
            <div className="content">
              <div className="text-wrapper">
                <p className="text">
                  ...
                  editorial illustrations and book covers, her style is
                  recognized by her simple and perfectly arranged shapes as well
                  as her rich and vibrant color palette. Striking pewter studded
                  epaulettes silver zips inner drawstring waist channel
                </p>
              </div>
          ...
          <div className="section-details fade-anim">
            <div className="details-info">
              ...
              <p className="text">
                ...
                elements logically designers working process by wireframing.
              </p>
            </div>
            <div className="details-info">
              <h3 className="title">Components</h3>
              <p className="text">
                From textile design to murals, editorial illustrations and book
                covers, her style is recognized by her simple and perfectly
                arranged shapes as well as her rich and vibrant color palette.
              </p>
            </div>
          </div>
        </div>
